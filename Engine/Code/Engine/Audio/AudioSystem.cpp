...
AudioChannelHandle AudioSystem::GetChannelForChannelID(int channelID)
{
	FMOD::Channel* newChannel = nullptr;
	m_fmodSystem->getChannel(channelID, &newChannel);
	return (AudioChannelHandle)newChannel;
}
...
//---------------------------------------------------------------------------
AudioChannelHandle AudioSystem::PlaySound(SoundID soundID, float volumeLevel, AudioChannelHandle prefferedChannel)
{
	...
	FMOD_CHANNELINDEX howToPick = prefferedChannel ? FMOD_CHANNEL_REUSE : FMOD_CHANNEL_FREE;
	FMOD::Channel* channelAssignedToSound = (FMOD::Channel*)prefferedChannel;
	m_fmodSystem->playSound(howToPick, sound, false, &channelAssignedToSound);
