...
{
	const float OCTAVE_OFFSET = 0.636764989593174f; // Translation/bias to add to each octave
	const float SQRT_3_OVER_3 = (float)sqrt(3) / 3.f;

	const Vector3 gradients[ 8 ] = // Traditional "12 edges" requires modulus and isn't any better.
	{
		Vector3( +SQRT_3_OVER_3, +SQRT_3_OVER_3, +SQRT_3_OVER_3 ), // Normalized unit 3D vectors
		Vector3( -SQRT_3_OVER_3, +SQRT_3_OVER_3, +SQRT_3_OVER_3 ), //  pointing toward cube
		Vector3( +SQRT_3_OVER_3, -SQRT_3_OVER_3, +SQRT_3_OVER_3 ), //  corners, so components
		Vector3( -SQRT_3_OVER_3, -SQRT_3_OVER_3, +SQRT_3_OVER_3 ), //  are all sqrt(3)/3, i.e.
		Vector3( +SQRT_3_OVER_3, +SQRT_3_OVER_3, -SQRT_3_OVER_3 ), // 0.5773502691896257645091f.
		Vector3( -SQRT_3_OVER_3, +SQRT_3_OVER_3, -SQRT_3_OVER_3 ), // These are slightly better
		Vector3( +SQRT_3_OVER_3, -SQRT_3_OVER_3, -SQRT_3_OVER_3 ), // than axes (1,0,0) and much
		Vector3( -SQRT_3_OVER_3, -SQRT_3_OVER_3, -SQRT_3_OVER_3 )  // faster than edges (1,1,0).
	};
